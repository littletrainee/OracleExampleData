...
BEGIN
    ...
    IF V_EXIST <> 0 THEN
        EXECUTE IMMEDIATE 'DROP TABLE ORDER_DETAILS CASCADE CONSTRAINT PURGE';
    END IF;

    SELECT COUNT(*)
      INTO V_EXIST
      FROM USER_SEQUENCES
     WHERE SEQUENCE_NAME = 'SEQ_ORDER_DETAILS';

    IF V_EXIST <> 0 THEN
       EXECUTE IMMEDIATE 'DROP SEQUENCE SEQ_ORDER_DETAILS'; 
    END IF;
END;
/
...
CREATE TABLE ORDER_DETAILS (
    ...
    UNIT_PRICE  NUMBER(19,4) DEFAULT 0 NOT NULL, 
...
ALTER TABLE ORDER_DETAILS DISABLE CONSTRAINT CK_ORDER_DETAILS_DISCOUNT;
ALTER TABLE ORDER_DETAILS DISABLE CONSTRAINT CK_ORDER_DETAILS_QUANTITY;
ALTER TABLE ORDER_DETAILS DISABLE CONSTRAINT CK_ORDER_DETAILS_UNIT_PRICE; 
...
ALTER TABLE ORDER_DETAILS ENABLE CONSTRAINT CK_ORDER_DETAILS_DISCOUNT;
ALTER TABLE ORDER_DETAILS ENABLE CONSTRAINT CK_ORDER_DETAILS_QUANTITY;
ALTER TABLE ORDER_DETAILS ENABLE CONSTRAINT CK_ORDER_DETAILS_UNIT_PRICE; 